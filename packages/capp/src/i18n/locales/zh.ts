...
export default {
  ...
  // ==================== Session hero ====================
  "session.hero_title": "你想先做什么？",
  "session.hero_subtitle": "选择一个起点，或者直接在下面输入。",
  "session.hero_browser_title": "自动化你的浏览器",
  "session.hero_browser_description": "配置浏览器动作，从 OpenWork 运行稳定的网页任务。",
  "session.hero_soul_title": "给我一个 Soul",
  "session.hero_soul_description":
    "在多个会话之间保留你的目标和偏好，并进行轻量的定时回访。更多自主意味着可能会有一些后台运行，但一条指令就能完全回滚，在「灵魂」区域可以审计完整的配置与心跳记录。",

  // ==================== Worker setup ====================
  "worker.setup_first_title": "设置你的第一个 worker",
  "worker.setup_first_description": "在开始会话之前，OpenWork 需要一个本地或远程 worker。",
  "worker.create_local": "创建本地 worker",
  "worker.connect_remote": "连接远程 worker",
  "worker.create_or_connect": "创建或连接 worker",
  "worker.add": "添加 worker",
  "worker.new": "新建 worker",
  "worker.label": "工作区",
  "worker.connect_remote_short": "连接远程",
  "worker.import_config": "导入配置",
  "worker.edit_name": "编辑名称",
  "worker.share": "分享…",
  "worker.test_connection": "测试连接",
  "worker.edit_connection": "编辑连接",
  "worker.remove_workspace": "移除工作区",
  "worker.recover": "恢复",
  "worker.reveal_finder": "在 Finder 中显示",
  "worker.reveal_explorer": "在资源管理器中显示",
  ...
  "scheduled.title": "自动化",
  "scheduled.beta": "测试版",
  "scheduled.description_remote": "从连接的 OpenWork 服务器按计划运行的自动化任务。",
  "scheduled.description_local": "在此设备上按计划运行的自动化任务。",
  "scheduled.learn_more": "了解更多",
  "scheduled.refresh": "刷新",
  "scheduled.refreshing": "正在刷新…",
  "scheduled.support_desktop_only": "计划任务需要桌面应用。",
  "scheduled.support_windows_unsupported": "调度器目前尚不支持 Windows。",
  "scheduled.source_label_remote": "来自 OpenWork 服务器",
  "scheduled.source_label_local": "来自本地调度器",
  "scheduled.scheduler_label_remote": "OpenWork 服务器",
  "scheduled.scheduler_label_local": "本地",
  "scheduled.no_automations": "还没有自动化任务。可以先选一个模板，或者创建你自己的自动化提示词。",
  "scheduled.explore_more": "查看更多",
  "scheduled.new_automation": "新建自动化",
  "scheduled.template.daily_planning.name": "每日计划简报",
  "scheduled.template.daily_planning.desc": "根据你的任务和日历制定清晰计划。",
  "scheduled.template.inbox_zero.name": "收件箱清零助手",
  "scheduled.template.inbox_zero.desc": "汇总未读消息并草拟简短回复。",
  "scheduled.template.meeting_prep.name": "会议准备笔记",
  "scheduled.template.meeting_prep.desc": "为明天的会议生成准备要点。",
  "scheduled.template.weekly_wins.name": "周总结",
  "scheduled.template.weekly_wins.desc": "生成周五的成就、阻碍和下一步总结。",
  "scheduled.template.learning_digest.name": "学习摘要",
  "scheduled.template.learning_digest.desc": "将收藏的链接和笔记整理成每周摘要。",
  "scheduled.template.habit_checkin.name": "习惯打卡",
  "scheduled.template.habit_checkin.desc": "全天进行简单的进展检查。",
  "scheduled.delete_title": "删除自动化？",
  "scheduled.cancel": "取消",
  "scheduled.delete": "删除",
  "scheduled.deleting": "删除中",
  "scheduled.create_automation": "创建自动化",
  "scheduled.create_automation_desc": "自动化通过在新会话中运行提示词来调度。我们会为你预填一条提示词并发送。",
  "scheduled.view_docs": "查看文档",
  "scheduled.install_scheduler": "安装调度器",
  "scheduled.installing_scheduler": "安装中…",
  "scheduled.reload_openwork": "重新加载 OpenWork",
  "scheduled.reloading": "重新加载中…",
  "scheduled.run": "运行",
  "scheduled.gate_reload_title": "重新加载 OpenWork 以启用自动化",
  "scheduled.gate_reload_desc": "OpenCode 在启动时加载插件。请重新加载 OpenWork 以启用 opencode-scheduler。",
  "scheduled.gate_install_title": "安装调度器以解锁自动化",
  "scheduled.gate_install_desc": "自动化通过 opencode-scheduler 插件运行。将其添加到此工作区以启用调度。",

  // ==================== Inbox ====================
  "inbox.title": "收件箱",
  "inbox.drop_files": "拖放文件或点击上传",
  "inbox.share_with_worker": "与你的远程 worker 共享文件。",
  "inbox.connect_to_see": "连接以查看收件箱文件。",
  "inbox.no_files": "收件箱暂无文件。",
  "inbox.refresh": "刷新收件箱",
  "inbox.drop_here": "将文件拖放到此处上传",
  "inbox.connect_to_upload": "连接 worker 以上传",
  "inbox.uploading": "正在上传…",
  "inbox.copy_path": "复制收件箱路径",
  "inbox.connect_to_upload_files": "连接 worker 以上传收件箱文件。",
  "inbox.uploaded_to_worker": "已上传到 worker 收件箱。",
  "inbox.connect_to_download": "连接 worker 以下载收件箱文件。",
  "inbox.showing_first": "显示前 {count} 项",

  // ==================== Artifacts ====================
  "artifacts.reveal_file": "在文件管理器中显示文件",
  "artifacts.reveal_image": "在文件管理器中显示图片",
  "artifacts.show_fewer": "显示更少",
  "artifacts.show_more": "再显示 {count} 项",
  ...
  // ==================== Extensions overview ====================
  "extensions.title": "扩展",
  "extensions.subtitle": "在一个位置管理 Apps（MCP）和 OpenCode 插件。",
  "extensions.connected_apps": "{count} 个应用{suffix}已连接",
  "extensions.connected_plugins": "{count} 个插件{suffix}",
  ...
  "extensions.plugins_section_title": "插件（OpenCode）",

  // ==================== Soul ====================
  "soul.cadence_6h": "每 6 小时",
  "soul.cadence_12h": "每 12 小时",
  "soul.cadence_daily": "每天一次",
  "soul.never": "从未",
  "soul.status_on": "Soul 已开启",
  "soul.status_stale": "心跳过期",
  "soul.status_error": "心跳错误",
  "soul.status_off": "Soul 已关闭",
  "soul.header_title": "Soul 与心跳",
  "soul.header_description": "在这里启用 Soul、审计接线情况，并在调整下一步之前验证心跳证明。",
  "soul.refresh": "刷新",
  "soul.refreshing": "正在刷新…",
  "soul.card_worker": "WORKER",
  "soul.card_last_heartbeat": "最后心跳",
  "soul.card_heartbeat_count": "心跳次数",
  "soul.card_schedule": "计划",
  "soul.card_no_schedule": "尚未配置心跳计划",
  "soul.summary_unloaded": "尚未加载 Soul 状态。",
  "soul.off_banner": "当前 Soul 处于关闭状态。运行一次初始化以创建记忆、调度接线，以及可回滚的命令。",
  "soul.enable_button": "启用 Soul 模式",
  "soul.audit_title": "Soul 启用检查",
  "soul.audit_progress": "{passed}/{total} 项检查已通过",
  "soul.audit_memory_label": "Soul 记忆文件",
  "soul.audit_instructions_label": "指令接线",
  "soul.audit_command_label": "心跳命令",
  "soul.audit_job_label": "心跳计划",
  "soul.audit_log_label": "心跳日志",
  "soul.audit_proof_label": "最近心跳证明",
  "soul.audit_waiting_status": "等待 Soul 状态……",
  "soul.audit_proof_waiting": "运行一次心跳以验证设置。",
  "soul.audit_memory_missing": "缺少 .opencode/soul.md",
  "soul.audit_instructions_ok": "opencode 配置会加载 Soul 记忆",
  "soul.audit_instructions_missing": "在指令中加入 .opencode/soul.md",
  "soul.audit_command_ok": "已检测到 /soul-heartbeat",
  "soul.audit_command_missing": "创建 /soul-heartbeat",
  "soul.audit_job_missing": "尚未配置 soul-heartbeat 任务",
  "soul.audit_log_missing": "缺少 heartbeat.jsonl",
  "soul.audit_proof_latest": "最新检查时间：{time}",
  "soul.audit_proof_none": "尚无检查记录。",
  "soul.heartbeat_proof_title": "心跳证明",
  "soul.heartbeat_proof_description": "查看最近的检查记录、未完事项和下一步动作。",
  "soul.no_heartbeat_entries": "还没有心跳记录。现在运行一次心跳（或 `/soul-heartbeat`）以生成证明。",
  "soul.latest_checkin": "最新检查：{time}",
  "soul.loose_ends_label": "未完事项",
  "soul.next_prefix": "下一步：",
  "soul.steering_title": "引导清单",
  "soul.steering_description": "从这里依次触发引导步骤，确认 Soul 输出已在心跳证明中可见。",
  "soul.steering_heartbeat_label": "心跳已记录",
  "soul.steering_loose_ends_label": "未完事项已列出",
  "soul.steering_next_action_label": "下一步已就绪",
  "soul.steering_loose_ends_tracked": "{count} 项未完事项已记录",
  "soul.steering_no_loose_ends": "暂无未完事项",
  "soul.steering_generate_next_action": "通过引导操作生成一个",
  "soul.current_focus_label": "当前专注",
  "soul.current_focus_placeholder": "为远程工作者发布 Soul 界面",
  "soul.update_focus": "更新专注",
  "soul.boundaries_label": "边界与防护",
  ...
  "soul.prioritize_loose_ends": "优先处理未完事项",
  "soul.improvement_sweep": "改进扫描",
  "soul.heartbeat_completed": "心跳已完成",
  "soul.heartbeat_still_running": "心跳仍在运行",
  "soul.heartbeat_in_progress": "心跳进行中",
  "soul.heartbeat_task_started": "已启动心跳任务，正在等待新的检查记录……",
  "soul.heartbeat_still_waiting": "仍在等待心跳输出。打开任务线程查看工具结果并重试。",
  "soul.heartbeat_latest": "最新检查：{time}",
  "soul.heartbeat_status_hint": "手动运行一次心跳，在此卡片中查看实时状态。",
  ...
  "skills.worker_profile": "Worker 配置",
  "skills.worker_profile_desc": "技能是此 worker 的核心能力。从 Hub 添加或直接在聊天中创建新技能。",
  "skills.create_skill_in_chat": "在聊天中创建技能",
  "skills.card_installed": "已安装",
  "skills.card_hub_available": "Hub 可用",
  "skills.card_skill_creator": "技能创建器",
  "skills.card_not_installed": "未安装",
  "skills.card_mode": "模式",
  "skills.card_mode_local": "本地",
  "skills.card_mode_server": "服务器",
  "skills.search_hub_placeholder": "搜索已安装或 Hub 中的技能",
  "skills.new_skill": "新建技能",
  "skills.install_from_link": "从链接安装",
  "skills.install_from_link_title": "从链接安装技能",
  "skills.install_section_title": "安装技能",
  "skills.capability_setup": "能力配置",
  "skills.refresh_hub": "刷新 Hub",
  "skills.refresh_hub_title": "刷新 Hub 目录",
  "skills.no_hub_available": "暂无 Hub 技能。",
  "skills.from_hub": "来自 openwork-hub",
  "skills.install_skill_title": "安装 {name}",
  "skills.installing": "正在安装…",
  "skills.add": "添加",
  "skills.install_from_link_modal_title": "从链接安装",
  "skills.install_from_link_modal_desc": "粘贴技能包链接，预览后再安装。",
  "skills.install_link_label": "链接",
  "skills.preview": "预览",
  "skills.loading": "加载中…",
  "skills.skill_conflict": "已存在同名技能。",
  "skills.install": "安装",
  "skills.keep_both": "保留两个",
  "skills.overwrite": "覆盖",
  "skills.refresh": "刷新",
  ...
  "skills.no_skills": "在 `.opencode/skills`、`.claude/skills` 或 `~/.agents/skills` 中未检测到任何技能。",
...
"mcp.apps_title": "应用",
"mcp.apps_subtitle": "连接常用工具，让 OpenWork 能代表您使用它们。",
...
"mcp.your_apps": "已连接的应用",
"mcp.last_synced": "上次同步",
"mcp.no_apps_yet": "尚未连接任何应用",
"mcp.no_apps_hint": "在上方连接一个应用以开始使用。",
...
"mcp.advanced_settings_hint": "编辑配置文件并手动管理连接。",
  "mcp.hide": "隐藏",
  "mcp.show": "显示",
  ...
  "settings.appearance_system_hint": "系统模式会自动跟随操作系统的外观设置。",
  ...
  "settings.auto_compact_title": "自动压缩上下文",
  "settings.auto_compact_hint": "在任务完成后自动压缩上下文。",
  "settings.developer_mode_title": "开发者模式",
  "settings.developer_mode_hint": "启用调试工具、诊断信息以及开发者选项卡。",
  "settings.developer_mode_enable": "启用开发者模式",
  "settings.developer_mode_disable": "关闭开发者模式",
  "settings.developer_mode_status_on": "开发者面板已启用。",
  "settings.developer_mode_status_off": "启用后即可访问开发者面板。",
  "settings.reconnect_server": "重新连接服务器",
  "settings.reconnecting": "正在重新连接…",
  "settings.restart_local_server": "重启本地服务器",
  "settings.restarting_local_server": "正在重启…",
