...
export default {
  ...
  "dashboard.sandbox_kind": "Sandbox",
  ...
  "session.hero_subtitle": "Pick a starting point or just type below.",
  "session.hero_browser_title": "Automate your browser",
  "session.hero_browser_description": "Set up browser actions and run reliable web tasks from OpenWork.",
  "session.hero_soul_title": "Give me a soul",
  "session.hero_soul_description":
    "Keep your goals and preferences across sessions with light scheduled check-ins. More autonomy can create extra background runs, but revert is one command. Audit setup and heartbeat evidence from the Soul section.",

  // ==================== Worker setup ====================
  "worker.setup_first_title": "Set up your first worker",
  "worker.setup_first_description": "OpenWork needs a local or remote worker before you can start a session.",
  "worker.create_local": "Create local worker",
  "worker.connect_remote": "Connect remote worker",
  "worker.create_or_connect": "Create or connect a worker",
  "worker.add": "Add a worker",
  "worker.new": "New worker",
  "worker.label": "Worker",
  "worker.connect_remote_short": "Connect remote",
  "worker.import_config": "Import config",
  "worker.edit_name": "Edit name",
  "worker.share": "Share...",
  "worker.test_connection": "Test connection",
  "worker.edit_connection": "Edit connection",
  "worker.remove_workspace": "Remove workspace",
  "worker.recover": "Recover",
  "worker.reveal_finder": "Reveal in Finder",
  "worker.reveal_explorer": "Reveal in Explorer",
  ...
  "scheduled.beta": "Beta",
  "scheduled.description_remote": "Automations that run on a schedule from the connected OpenWork server.",
  "scheduled.description_local": "Automations that run on a schedule from this device.",
  "scheduled.learn_more": "Learn more",
  "scheduled.refresh": "Refresh",
  "scheduled.refreshing": "Refreshing",
  "scheduled.support_desktop_only": "Scheduled tasks require the desktop app.",
  "scheduled.support_windows_unsupported": "Scheduler is not supported on Windows yet.",
  "scheduled.source_label_remote": "From OpenWork server",
  "scheduled.source_label_local": "From local scheduler",
  "scheduled.scheduler_label_remote": "OpenWork server",
  "scheduled.scheduler_label_local": "Local",
  ...
  "scheduled.template.daily_planning.name": "Daily planning brief",
  "scheduled.template.daily_planning.desc": "Build a focused plan from your tasks and calendar.",
  "scheduled.template.inbox_zero.name": "Inbox zero helper",
  "scheduled.template.inbox_zero.desc": "Summarize unread messages and draft short replies.",
  "scheduled.template.meeting_prep.name": "Meeting prep notes",
  "scheduled.template.meeting_prep.desc": "Generate prep bullets for tomorrow's meetings.",
  "scheduled.template.weekly_wins.name": "Weekly wins recap",
  "scheduled.template.weekly_wins.desc": "Create a Friday recap of wins, blockers, and next steps.",
  "scheduled.template.learning_digest.name": "Learning digest",
  "scheduled.template.learning_digest.desc": "Turn saved links and notes into a weekly digest.",
  "scheduled.template.habit_checkin.name": "Habit check-in",
  "scheduled.template.habit_checkin.desc": "Run a quick accountability check through the day.",
  ...
  "scheduled.installing_scheduler": "Installing...",
  ...
  "scheduled.gate_reload_desc": "OpenCode loads plugins at startup. Reload OpenWork to activate opencode-scheduler.",
  "scheduled.gate_install_title": "Install the scheduler to unlock automations",
  "scheduled.gate_install_desc": "Automations run through the opencode-scheduler plugin. Add it to this workspace to enable scheduling.",

  // ==================== Inbox ====================
  "inbox.title": "Inbox",
  "inbox.drop_files": "Drop files or click to upload",
  "inbox.share_with_worker": "Share files with your remote worker.",
  "inbox.connect_to_see": "Connect to see inbox files.",
  "inbox.no_files": "No inbox files yet.",
  "inbox.refresh": "Refresh inbox",
  "inbox.drop_here": "Drop files here to upload",
  "inbox.connect_to_upload": "Connect to a worker to upload",
  "inbox.uploading": "Uploading...",
  "inbox.copy_path": "Copy inbox path",
  "inbox.connect_to_upload_files": "Connect to a worker to upload inbox files.",
  "inbox.uploaded_to_worker": "Uploaded to worker inbox.",
  "inbox.connect_to_download": "Connect to a worker to download inbox files.",
  "inbox.showing_first": "Showing first {count}",

  // ==================== Artifacts ====================
  "artifacts.reveal_file": "Reveal file in Finder",
  "artifacts.reveal_image": "Reveal image in Finder",
  ...
  "extensions.connected_plugins": "{count} plugin{suffix}",
  "extensions.filter_all": "All",
  "extensions.filter_apps": "Apps",
  "extensions.filter_plugins": "Plugins",
  "extensions.refresh": "Refresh",
  "extensions.apps_section_title": "Apps (MCP)",
  "extensions.plugins_section_title": "Plugins (OpenCode)",
  ...
  "soul.header_title": "Soul and Heartbeat",
  "soul.header_description":
  ...
  "soul.card_worker": "Worker",
  "soul.card_last_heartbeat": "Last heartbeat",
  "soul.card_heartbeat_count": "Heartbeat count",
  "soul.card_schedule": "Schedule",
  "soul.card_no_schedule": "No heartbeat schedule",
  "soul.summary_unloaded": "Soul status has not been loaded yet.",
  "soul.off_banner":
    "Soul is currently off. Run setup once to create memory, scheduler wiring, and reversible commands for this worker.",
  "soul.enable_button": "Enable soul mode",
  "soul.audit_title": "Soul activation audit",
  "soul.audit_progress": "{passed}/{total} checks passing",
  ...
  "soul.audit_proof_waiting": "Run one heartbeat to verify setup.",
  ...
  "soul.audit_command_ok": "/soul-heartbeat detected",
  "soul.audit_command_missing": "Create /soul-heartbeat",
  "soul.audit_job_missing": "No soul-heartbeat job",
  "soul.audit_log_missing": "Missing heartbeat.jsonl",
  "soul.audit_proof_latest": "Latest check-in {time}",
  "soul.audit_proof_none": "No check-ins yet",
  "soul.heartbeat_proof_title": "Heartbeat proof",
  ...
  "soul.loose_ends_label": "Loose ends",
  "soul.next_prefix": "Next:",
  "soul.steering_title": "Steering checklist",
  "soul.steering_description": "Trigger steering steps in order and ensure Soul output is visible in the heartbeat proof.",
  ...
  "soul.steering_loose_ends_tracked": "{count} loose end(s) tracked",
  ...
  "soul.heartbeat_task_started": "Heartbeat task started. Waiting for a fresh check-in entry...",
  "soul.heartbeat_still_waiting":
    "Still waiting for heartbeat output. Open the task thread to inspect tool results and retry.",
  "soul.heartbeat_latest": "Latest check-in: {time}.",
  "soul.heartbeat_status_hint": "Start a manual heartbeat and watch this card for live status.",
  ...
  "skills.create_skill_in_chat": "Create skill in chat",
  "skills.card_installed": "Installed",
  "skills.card_hub_available": "Hub available",
  "skills.card_skill_creator": "Skill creator",
  "skills.card_not_installed": "Not installed",
  "skills.card_mode": "Mode",
  "skills.card_mode_local": "Local",
  "skills.card_mode_server": "Server",
  "skills.search_hub_placeholder": "Search installed or hub skills",
  "skills.new_skill": "New skill",
  "skills.install_from_link": "Install from link",
  "skills.install_from_link_title": "Install a skill from a link",
  "skills.install_section_title": "Install skills",
  "skills.capability_setup": "Capability setup",
  "skills.refresh_hub": "Refresh hub",
  "skills.refresh_hub_title": "Refresh hub catalog",
  "skills.no_hub_available": "No hub skills available.",
  "skills.from_hub": "From openwork-hub",
  "skills.install_skill_title": "Install {name}",
  "skills.installing": "Installing",
  "skills.add": "Add",
  "skills.install_from_link_modal_title": "Install from link",
  "skills.install_from_link_modal_desc": "Paste a skill bundle URL, preview it, then install.",
  "skills.install_link_label": "Link",
  "skills.preview": "Preview",
  "skills.loading": "Loading…",
  "skills.skill_conflict": "A skill with this name is already installed.",
  ...
  "settings.appearance_system_hint": "System mode follows your OS preference automatically.",
  ...
  "settings.developer_mode_enable": "Enable Developer Mode",
  "settings.developer_mode_disable": "Disable Developer Mode",
  "settings.developer_mode_status_on": "Developer panel enabled.",
  "settings.developer_mode_status_off": "Enable this to access the Developer panel.",
  ...
  "settings.restarting_local_server": "Restarting...",
