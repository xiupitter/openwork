          ...
          <div class="space-y-6">
            <div class="bg-gray-2/30 border border-gray-7/60 rounded-2xl p-5 space-y-4">
              ...
              <div class="flex flex-wrap items-center gap-3">
                ...
                >
                  {props.providerAuthBusy ? t("settings.loading_providers") : t("settings.connect_provider")}
                </Button>
            ...
            <div class="bg-gray-2/30 border border-gray-7/60 rounded-2xl p-5 space-y-4">
              <div>
                ...
                <div class="text-xs text-gray-9">{t("settings.appearance_hint")}</div>
              </div>
              ...
              <div class="text-xs text-gray-8">{t("settings.appearance_system_hint")}</div>
            </div>
          </div>
        </Match>
        ...
        <Match when={activeTab() === "model"}>
          <div class="space-y-6">
            <div class="bg-gray-2/30 border border-gray-6/50 rounded-2xl p-5 space-y-4">
              ...
              <div class="flex items-center justify-between bg-gray-1 p-3 rounded-xl border border-gray-6 gap-3">
                <div class="min-w-0">
                  <div class="text-sm text-gray-12">{translate("settings.auto_compact_title")}</div>
        ...
        <Match when={activeTab() === "advanced"}>
          <div class="space-y-6">
            <div class="bg-gray-2/30 border border-gray-7/60 rounded-2xl p-5 space-y-3">
              ...
              <div class="text-xs text-gray-9">{translate("settings.developer_mode_hint")}</div>
              <div class="pt-1 flex flex-wrap items-center gap-3">
                ...
                >
                  ...
                  {props.developerMode ? translate("settings.developer_mode_disable") : translate("settings.developer_mode_enable")}
                </button>
                <div class="text-xs text-gray-10">
                  {props.developerMode
                    ? translate("settings.developer_mode_status_on")
                    : translate("settings.developer_mode_status_off")}
                </div>
              </div>
            </div>
            ...
            <div class="bg-gray-2/30 border border-gray-7/60 rounded-2xl p-5 space-y-3">
              ...
              <div class="pt-2 flex flex-wrap gap-2">
                ...
                <Show when={isLocalEngineRunning()}>
                  ...
                  {openworkRestartBusy()
                    ? t("settings.restarting_local_server")
